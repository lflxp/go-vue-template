  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/demo/playground/frame/elementui', title: 'ElementUI', icon: 'pie-chart' },
        { path: '/demo/playground/frame/admin', title: 'Admin后台管理', icon: 'pie-chart' },
        { path: '/demo/playground/frame/black', title: '黑客帝国', icon: 'pie-chart' },
        { path: '/demo/playground/frame/tablelist', title: 'tablelist', icon: 'pie-chart' },
        { path: '/demo/playground/frame/blog', title: '个人博客', icon: 'code' },
      ]
    },
    {
      title: '新窗口打开链接',
